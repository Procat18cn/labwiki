...
| 版本 | 日期 | 主要更新 |
|------|------|----------|
| v5 | 2026-04-18 | 修复搜索框居中、调色板按钮可见性、点击外部关闭搜索 |
| v4 | 2026-04-18 | 合并双搜索框、添加调色板切换、添加文档下载功能 |
| v3 | 2026-04-18 | 全宽布局、侧栏可隐藏、可折叠导航、顶栏设计 |
| v2 | 2026-04-18 | 修复搜索功能、优化导航样式 |
| v1 | 2026-04-17 | 初始版本，基础框架搭建 |
