...
### 系统基础与配置
- [硬件信息查看](../environments/ubuntu/system-basics.md#一硬件信息查看)
- [显卡与显示配置](../environments/ubuntu/system-basics.md#二显卡与显示配置)
- [幽灵显示器解决](../environments/ubuntu/system-basics.md#二显卡与显示配置)
...
- [GitHub Desktop安装](../environments/ubuntu/software-management.md#二deb包安装)
...
- [磁盘管理](../environments/ubuntu/filesystem-storage.md#三磁盘管理基础)
...
| 关键词 | 相关文档 |
|--------|---------|
| `adduser` | [用户与权限管理](../environments/ubuntu/user-permissions.md) |
...
| `lshw` | [系统基础与配置](../environments/ubuntu/system-basics.md) |
| `mount` | [文件系统与存储](../environments/ubuntu/filesystem-storage.md) |
...
| 问题场景 | 推荐文档 |
|---------|---------|
| 新装Ubuntu，想查看硬件配置 | [系统基础与配置](../environments/ubuntu/system-basics.md) |
| 服务器出现幽灵显示器 | [系统基础与配置 - 显卡配置](../environments/ubuntu/system-basics.md#二显卡与显示配置) |
| 需要创建新用户并分配权限 | [用户与权限管理](../environments/ubuntu/user-permissions.md) |
